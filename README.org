...
This is a static site source built with GNU M4, Org-mode, and
Make. . This site generating approach was strongly inspired by
LdBeth's blog at https://ldbeth.sdf.org/mcs.html
...
#+begin_src html :tangle src/templates/header.html.m4
  ...
  <html lang="en">
    <head>
      <meta charset="utf-8">
      <link rel="icon" href="data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>鳰</text></svg>">
